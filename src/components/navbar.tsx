        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex items-center justify-between h-16">
            ...
            <div 
              ...
              className="flex items-center group transition-all duration-300 hover:scale-105 cursor-pointer"
            >
        ...
        {isOpen && (
          <div className="md:hidden bg-black/95 backdrop-blur-lg border-t border-red-600/20 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 py-6 relative z-10">
              ...
              <div className="mt-6 pt-6 border-t border-red-600/20 space-y-3">
